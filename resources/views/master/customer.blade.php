                            ...
                            <td>
                                <form action="{{ url('customer') . '/' . $row->id }}" method="POST">
                                    <button type="button" class="btn btn-warning btn-sm editBtn" data-toggle="modal"
                                        data-target="#edtModel" data-id="{{ $row->id }}"
                                        data-kode="{{ $row->kode }}" data-name="{{ $row->name }}"
                                        data-telp="{{ $row->telp }}">
                                        Edit</button>
                                    @csrf
                                    @method('delete')
...
@push('modal-add')
    ...
    <!-- Modal Edit-->
    <div class="modal fade" id="edtModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
